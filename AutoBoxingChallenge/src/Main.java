...
class Bank {
    ...
    private Customer getCostumer(String customerName) {
    ...
    public void addNewCustomer(String customerName, double initialDeposit) {
        if (getCostumer(customerName) == null) {
    ...
    public void addTransaction(String name, double transactionAmount) {
        Customer customer = getCostumer(name);
        if (customer != null) {
    ...
    public void printStatement(String customerName) {
        Customer customer = getCostumer(customerName);
        if (customer == null) {
            return;
        }
